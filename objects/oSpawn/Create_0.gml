...
waves = [
	...
	[ //3
		[oEnemy2, 6, room_speed * 1],[oEnemy, 8, room_speed * 1]
	],
	[ //4 
		[oEnemy, 6, room_speed * 1.5],[oEnemy3, 6, room_speed * 1]
	],
	[ //5
		[oEnemy2, 5, room_speed * 1],[oEnemy, 6, room_speed * 1],[oEnemy3, 10, room_speed * 1]
	],
	[ //6 IK HEB DE RONDES NA DEZE NIET VERDER GEMAAKT
