...
global.trivia_questions = [
    ["Wat doet een cloud engineer?", ["maakt cloud netwerken", "ontwerpt cloud structuren", "Adviseert bedrijven"], 1],
	...
	["Welke van de volgende platforms is géén cloudplatform?", ["Het ontwerpen van fysieke netwerken", "Het ontwikkelen van cloudoplossingen en beheren van cloudomgevingen", "Het maken van websites", "Het onderhouden van computers bij gebruikers"], 1],
];
}
